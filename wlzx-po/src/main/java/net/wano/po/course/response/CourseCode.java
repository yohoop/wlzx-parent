package net.wano.po.course.response;
...
@ToString
public enum CourseCode implements ExceptionResult {
    ...
    COURSE_GET_NOTEXISTS(false,31103,"选择的课程不存在！"),
    COURSE_MEDIA_TEACHPLAN_GRADEERROR(false,31104,"允许选择第三级的课程计划关联视频！"),
    COURSE_PIC_EXISTS(false,31105,"图片已存在");
